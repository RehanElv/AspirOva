                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="<?= base_url ?>admin/feedback/index.php?user=<?= $row['id_user'] ?>" class="btn btn-primary ms-auto">
